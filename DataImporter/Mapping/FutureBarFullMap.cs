...
{
    public class FutureBarFullMap : ClassMap<FutureBarFull>
    {
        public FutureBarFullMap()
        {
            // AutoMap(); // 自動マッピングはカスタムマッピングと衝突する可能性があるためコメントアウト
            ...
            Map(m => m.IndexType).Name("Index_Type");
